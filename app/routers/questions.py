...
@router.get("/sessions/{session_id}/questions/{question_id}/speak")
def get_question_speech(
    session_id: str,
    question_id: str,
...
@router.get("/sessions/{session_id}/questions/{question_id}/answer/evaluation/speak")
